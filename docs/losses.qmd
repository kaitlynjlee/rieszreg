...
- **Random forest, augmentation-style** (`forestriesz.AugForestRieszRegressor`): all four losses. Each tree picks splits by the gain in the loss you chose, and each leaf stores that loss's closed-form optimum.
